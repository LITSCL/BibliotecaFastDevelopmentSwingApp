...
public class StartAudioUtil {
	...
	public void reproducir(String nombre, String formato) {
		try {
			AudioClip sonido;
			sonido = java.applet.Applet.newAudioClip(getClass().getResource("/cl/inacap/bibliotecafastdevelopmentswingapp/sound/" + nombre + "." + formato)); //El sonido tiene que estar obligatoriamente en un paquete (No se puede usar un Folder).
			sonido.play();
		} catch (Exception e) {
