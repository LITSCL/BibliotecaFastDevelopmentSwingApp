			...
			public void mouseReleased(MouseEvent e) {
				...
				if (filaSeleccionada < 0) 
				    ...
				    if (e.isPopupTrigger() && e.getComponent() instanceof JTable ) {
				    	...
				    	JMenuItem mi = new JMenuItem("Agregar telefono", new ImageIcon(MostrarClienteFrame.class.getResource("/cl/inacap/bibliotecafastdevelopmentSwingApp/imagenes/add.png"))); //Aca se crea un JMenuItem (Para luego añadirlo al PopUp).
