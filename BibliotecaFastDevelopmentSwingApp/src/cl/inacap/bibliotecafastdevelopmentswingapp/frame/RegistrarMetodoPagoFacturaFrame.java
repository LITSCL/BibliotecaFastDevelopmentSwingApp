...
public class RegistrarMetodoPagoFacturaFrame extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistrarMetodoPagoFacturaFrame frame = new RegistrarMetodoPagoFacturaFrame();
	 ...
	 * Create the frame.
	 */
	public RegistrarMetodoPagoFacturaFrame() {
		...
		btnNewButton.setIcon(new ImageIcon(RegistrarMetodoPagoFacturaFrame.class.getResource("/cl/inacap/bibliotecafastdevelopmentswingapp/image/add.png")));
		btnNewButton.addActionListener(e -> registrarMetodoPagoFactura(e));
	...
	private void registrarMetodoPagoFactura(ActionEvent e) {
		StartAudioUtil sau = new StartAudioUtil();
